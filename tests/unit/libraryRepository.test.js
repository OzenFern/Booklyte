...
describe('libraryRepository', () => {
    ...
    it('addBookToLibrary inserts a new library book and returns it', async () => {
        ...
        await expect(addBookToLibrary(bookId, status)).resolves.toEqual(createdLibraryBook);
    ...
    it('updateLibraryBook updates the library book and returns the updated row', async () => {
        ...
        await expect(updateLibraryBook(1, updates)).resolves.toEqual(updatedLibraryBook);
