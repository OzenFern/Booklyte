...
export function initHtmxFeedback() {
  document.body.addEventListener("htmx:responseError", (event) => {
    ...
    const message =
      responseDocument.querySelector(".flash__message")?.textContent?.trim() ||
    ...
    flash.innerHTML =
      '<p class="flash__message"></p><button type="button" class="flash__dismiss" data-flash-dismiss aria-label="Dismiss message">Dismiss</button>';
