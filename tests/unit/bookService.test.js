...
describe('bookService', () => {
    ...
    it('getBookById returns the found book with parsed authors or forwards the repository error', async () => {
        ...
        const book = { 
            book_id: 42, 
            title: 'The Hobbit',
            authors: '[{"author_id": 2, "name": "J.R.R. Tolkien", "openlibrary_id": "OL2"}]'
        };
        const expectedBook = {
            book_id: 42,
            title: 'The Hobbit',
    ...
    it('createBook creates the book and associates any supplied authors', async () => {
        ...
        const bookWithAuthors = {
            ...
            cover_url: 'https://example.com/dune.jpg',
            published_date: '1965-08-01',
            authors: [{ author_id: 7, name: 'Frank Herbert', openlibrary_id: 'OLA1' }]
        };
    ...
    it('putBook, patchBook, and deleteBook delegate through the repository', async () => {
        ...
        const patchedWithAuthors = { book_id: 9, title: 'Patched title', authors: [] };
        ...
        await expect(bookService.putBook(7, { title: 'Updated title' })).resolves.toEqual(bookWithAuthors);
        await expect(bookService.patchBook(9, { title: 'Patched title' })).resolves.toEqual(patchedWithAuthors);
