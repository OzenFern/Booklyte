...
describe('reviewService', () => {
    ...
    it('getReviewByLibraryBookId returns the found review or forwards the repository error', async () => {
        ...
        await expect(reviewService.getReviewByLibraryBookId(5)).resolves.toEqual(review);
    ...
    it('createReview creates a new review with validation', async () => {
        ...
        await expect(reviewService.createReview(reviewData)).resolves.toEqual(createdReview);
        expect(mocks.getReviewByLibraryBookId).toHaveBeenCalledWith(5);
    ...
    it('createReview prevents duplicate reviews', async () => {
        ...
        expect(result).toEqual({
            success: false,
            message: 'A review already exists for this library book. Use update instead.',
    ...
    it('createReview handles foreign key constraint violations', async () => {
        ...
        expect(result).toEqual({
            success: false,
            message: 'Library book does not exist. Cannot create review for non-existent library book.',
    ...
    it('updateReview validates review ID', async () => {
        ...
        await expect(reviewService.updateReview(null, { rating: 4.5 })).resolves.toEqual({
            success: false,
    ...
    it('updateReview returns error when review not found', async () => {
        ...
        const result = await reviewService.updateReview(99, { rating: 4.5, review_text: 'Updated text' });
