...
describe('libraryService', () => {
    ...
    it('getAllLibraryBooks delegates to the repository and returns its result', async () => {
        ...
        await expect(libraryService.getAllLibraryBooks()).resolves.toEqual(libraryBooks);
    ...
    it('getAllLibraryBooks handles repository errors', async () => {
        ...
        expect(mocks.handleServiceError).toHaveBeenCalledWith(error, 'Failed to fetch library books.');
    });
    ...
    it('getLibraryBookById returns the found library book or forwards the repository error', async () => {
        ...
        await expect(libraryService.getLibraryBookById(1)).resolves.toEqual(libraryBook);
    ...
    it('addBookToLibrary delegates to the repository and returns the result', async () => {
        ...
        // Act/Assert: the service should pass through the repository data.
        await expect(libraryService.addBookToLibrary(42, 'want_to_read')).resolves.toEqual(newLibraryBook);
    ...
    it('addBookToLibrary handles repository errors', async () => {
        ...
        await expect(libraryService.addBookToLibrary(42, 'reading')).resolves.toEqual({
            success: false,
            message: 'Failed to add book to library.',
            error: 'Duplicate book in library',
        });
        expect(mocks.handleServiceError).toHaveBeenCalledWith(error, 'Failed to add book to library.');
    });
    ...
    it('updateLibraryBook delegates to the repository and returns the result', async () => {
        ...
        // Act/Assert: the service should pass through the repository data.
        await expect(libraryService.updateLibraryBook(1, updates)).resolves.toEqual(updatedLibraryBook);
    ...
    it('updateLibraryBook handles repository errors', async () => {
        ...
        await expect(libraryService.updateLibraryBook(1, { status: 'reading' })).resolves.toEqual({
            success: false,
            message: 'Failed to update library book with id 1.',
            error: 'Update failed',
        });
        expect(mocks.handleServiceError).toHaveBeenCalledWith(error, 'Failed to update library book with id 1.');
    });
    ...
    it('removeBookFromLibrary delegates to the repository and returns the result', async () => {
        ...
        await expect(libraryService.removeBookFromLibrary(1)).resolves.toBeUndefined();
    ...
    it('removeBookFromLibrary handles repository errors', async () => {
        ...
        expect(mocks.handleServiceError).toHaveBeenCalledWith(error, 'Failed to remove library book with id 1.');
    });
});
